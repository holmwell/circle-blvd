...
directive('cbStoryPulser', ['$timeout', function ($timeout) {
    ...
    return {
        link: function (scope, element, attr) { 
            ...
            scope.$on('pulseStory', function (e, story) {
                pulse(story);
            });

            scope.$on('scrollToAndPulseStory', function (e, story, selector, onlyDirection) {
