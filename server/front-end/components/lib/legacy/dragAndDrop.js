...
var updateViewModelStoryOrder = function () {
    StoryListBus.$emit('story-order-updated', 'dragAndDrop.js');
}
...
export default function (circleIdParam, listIdParam, mindset, isScreenXs) {
    ...
    var hackRefresh = function () {
        // TODO ... do we still need this with Vue?
    ...
    var storyNodeMoved = function (ui, item, start, end) {
        ...
        var updateModelStoryOrder = function () {
            ...
            if (preMove.storyBefore) {
                preMove.storyBefore.nextId = preMove.storyAfter ? preMove.storyAfter.id : getLastStoryId(listId || circleId);
            }
            ...
            endStory.nextId = postMove.storyAfter ? postMove.storyAfter.id : getLastStoryId(listId || circleId);  
        }();
    ...
    var checkStoryListDom = function () {
        ...
        var element; 
        while (current && current.nextId !== getLastStoryId(listId || circleId)) {
            console.log("...");
