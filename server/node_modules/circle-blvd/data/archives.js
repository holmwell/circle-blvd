...
module.exports = function (couch) {
	...
	couch.archives = require('./couch/archives.js')(couch);
	...
	var addStoriesToArchive = function (stories, success, failure) {
		...
		couch.stories.findMany(storyIds, guard(failure, function (body) {
			...
			couch.archives.add(archives, guard(failure, function (body) {
				return success(body);
			}));
		}));
	};
