...
module.exports = function () {
	...
	var isCircleInGoodStanding = function (circleId, callback) {
		// Always true for now.
		// TODO: Use code in routes/circle (or probably vice versa)
		if (callback) {
			callback(null, true);			
		}
	};
	...
	return {
		...
		isCircleInGoodStanding: isCircleInGoodStanding,
		update: updateCircle
	};
}(); // closure
