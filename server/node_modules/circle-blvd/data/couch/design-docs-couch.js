...
designDocs.push(invitesDesignDoc);
			...
			bySlackTeamId: {
				map: function (doc) {
					if (doc.type === "circle" 
						&& doc.access 
						&& doc.access.slack 
						&& doc.access.slack.team_id) {
						emit(doc.access.slack.team_id, doc);
					}
				}
			},
...
designDocs.push(listsDesignDoc);


var listMetaDesignDoc = {
	url: '_design/list-meta',
	body: 
	{
		version: "1.0.0",
		language: "javascript",
...
designDocs.push(listMetaDesignDoc);
...
designDocs.push(adminDesignDoc);
