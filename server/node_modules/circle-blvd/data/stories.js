...
module.exports = function (couch) {
	...
	var oldMoveStory = function (story, newNextId, success, failure) {
		...
		couch.stories.findById(story.id, guard(failure, function (storyToMove) {
			...
			couch.stories.findByNextId(storyToMove.id, guard(failure, function (preMovePreviousStory) {
				couch.stories.findByNextId(newNextId, guard(failure, function (storyC) {
					couch.stories.findById(newNextId, guard(failure, function (storyE) {
						...
						couch.stories.findById(storyToMove.nextId, guard(failure, function (preMoveNextStory) {
	...
	var moveStoryBlock = function (startStory, endStory, newNextId, callback) {
		...
		couch.stories.findByListId(listId, guard(callback, function (allStories) {
			var storyMap = {};
