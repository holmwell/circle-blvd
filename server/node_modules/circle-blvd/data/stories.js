...
module.exports = function (couch) {
	...
	var oldRemoveStory = function (story, success, failure) {
		...
		couch.stories.findById(story.id, guard(failure, function (storyToRemove) {
			...
			couch.stories.findByNextId(storyToRemove.id, guard(failure, function (previousStory) {
				couch.stories.findById(storyToRemove.nextId, guard(failure, function (nextStory) {
