...
module.exports = function (couchModule) {
    couch = couchModule;
...
function create(doc, callback) {
    ...
    function createInvite() {
        ...
        couch.docs.get(doc.circleId, guard(callback, function (circle) {
            invite.circleName = circle.name;
            couch.db.insert(invite, inviteId, guard(callback, function (successDoc) {
...
function get(docId, callback) {
    couch.docs.get(docId, guard(callback, function (doc) {
        if (doc.type !== "invite") {
            callback(null);
            return;
        }
...
function findByCircleId(circleId, callback) {
    var params = {
        key: circleId
    };
    couch.view("invites/byCircleId", params, guard(callback, function (docs) {
...
function accept(invite, callback) {
    if (!invite) {
    ...
    get(invite._id, guard(callback, function (doc) {
        if (!doc) {
...
var actuallyPerformMaintenance = function (callback) {
    ...
    var deleteExpiredInvites = function () {
        ...
        couch.db.view("invites", "byExpires", options, guard(callback, function (body) {
            var bulkDoc = {};
            var options = {};
            bulkDoc.docs = [];
