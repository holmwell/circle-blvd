...
module.exports = function (settingsParam) {
...
function sendEmail (envelope, callback) {
    
    var initMailer = function (callback) { 
        settings.getAll(guard(callback, function (settings) {
    ...
    if (transporter && addresses) {
        ...
        initMailer(guard(callback, send));
    }
};
