...
module.exports = function () {
	...
	// Get all settings, from the cache if it's there.
	...
	// use in Express routes elsewhere. 
	...
	// to let them know, then invalidate our cache.
	var handleUpdate = function (setting) {
