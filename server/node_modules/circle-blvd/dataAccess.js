...
var data = {};
data.archives  = require('circle-blvd/data/archives');
data.circles   = require('circle-blvd/data/circles');
data.invites   = require('circle-blvd/data/invites');
data.docs      = require('circle-blvd/data/docs');
data.groups    = require('circle-blvd/data/groups');
data.settings  = require('circle-blvd/data/settings');
data.stories   = require('circle-blvd/data/stories');
data.lists     = require('circle-blvd/data/lists');
data.users     = require('circle-blvd/data/users');
data.waitlist  = require('circle-blvd/data/waitlist');
