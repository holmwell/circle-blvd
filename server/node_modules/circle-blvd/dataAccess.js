...
// To edit this config during testing, 
// take a look at the 'rewire' module.
var dbConfig = require('circle-blvd/data/database-config');
var couch    = dbConfig.couch;
...
function createCircle(circleName, adminEmailAddress, createStories, callback) {
	var circle = {
		name: circleName
	};
